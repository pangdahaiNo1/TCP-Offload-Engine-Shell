...
// clang-format off
  // some fifos
  // ack delay
  static stream<EventWithTuple, 4> event_eng_to_ack_delay_event_fifo("event_eng_to_ack_delay_event_fifo");
#pragma HLS aggregate variable = slookup_to_rx_app_tdest_lookup_rsp compact = bit
  static stream<EventWithTuple, 32> ack_delay_to_tx_eng_event_fifo("ack_delay_to_tx_eng_event_fifo");
...
#pragma HLS aggregate variable = tx_app_to_event_eng_set_event_fifo compact = bit
  stream<EventWithTuple, 512> rx_eng_to_event_eng_set_event_fifo("rx_eng_to_event_eng_set_event_fifo");
...
#pragma HLS aggregate variable = timer_to_event_eng_set_event_fifo compact = bit
  stream<ap_uint<1> > tx_eng_read_count_fifo("tx_eng_read_count_fifo");

  // port table
  stream<TcpPortNumber, 8> rx_eng_to_ptable_check_req_fifo("rx_eng_to_ptable_check_req_fifo");
  stream<ListenPortReq, 8> rx_app_to_ptable_listen_port_req_fifo("rx_app_to_ptable_listen_port_req_fifo");
#pragma HLS aggregate variable = rx_app_to_ptable_listen_port_req_fifo compact = bit
  stream<TcpPortNumber, 8> slookup_to_ptable_release_port_req_fifo("slookup_to_ptable_release_port_req_fifo");
...
#pragma HLS aggregate variable = ptable_to_rx_eng_check_rsp_fifo compact = bit
  stream<ListenPortRsp, 8> ptable_to_rx_app_listen_port_rsp_fifo("ptable_to_rx_app_listen_port_rsp_fifo");
#pragma HLS aggregate variable = ptable_to_rx_app_listen_port_rsp_fifo compact = bit
  ...
  stream<AppNotificationNoTDEST, 4> rx_eng_to_rx_app_notification_fifo("rx_eng_to_rx_app_notification_fifo");
  #pragma HLS aggregate variable = rx_eng_to_rx_app_notification_fifo compact = bit

  stream<AppNotificationNoTDEST, 4> rtimer_to_rx_app_notification_fifo("rtimer_to_rx_app_notification_fifo");
  #pragma HLS aggregate variable =rtimer_to_rx_app_notification_fifo  compact = bit

  stream<TcpSessionID, 4> rx_app_to_slookup_tdest_lookup_req_fifo("rx_app_to_slookup_tdest_lookup_req_fifo");

  stream<NetAXISDest, 4> slookup_to_rx_app_tdest_lookup_rsp_fifo("slookup_to_rx_app_tdest_lookup_rsp_fifo");
  ...
  #pragma HLS aggregate variable = sttable_to_rx_eng_rsp_fifo compact = bit
      stream<OpenConnRspNoTDEST,4>           rx_eng_to_tx_app_notification_fifo("rx_eng_to_tx_app_notification_fifo");
  #pragma HLS aggregate variable = rx_eng_to_tx_app_notification_fifo compact = bit
      stream<NewClientNotificationNoTDEST,4> rx_eng_to_tx_app_new_client_notification_fifo("rx_eng_to_tx_app_new_client_notification_fifo");
 ...
 //session lookup
  stream<TcpSessionID,4> sttable_to_slookup_release_req_fifo("sttable_to_slookup_release_req_fifo");
  ...
  #pragma HLS aggregate variable = slookup_to_tx_app_rsp_fifo compact = bit
    ...
    stream<TcpSessionID,4>      tx_app_to_slookup_check_tdest_req_fifo("tx_app_to_slookup_check_tdest_req_fifo");
    stream<NetAXISDest,4>       slookup_to_tx_app_check_tdest_rsp_fifo("slookup_to_tx_app_check_tdest_rsp_fifo");
    stream<ap_uint<16> ,4>           tx_eng_to_slookup_rev_table_req_fifo("tx_eng_to_slookup_rev_table_req_fifo");
    stream<ReverseTableToTxEngRsp,4> slookup_rev_table_to_tx_eng_rsp_fifo("slookup_rev_table_to_tx_eng_rsp_fifo");
 ...
 // state table
  ...
  #pragma HLS aggregate variable = tx_app_to_sttable_req_fifo  compact = bit
                                 ...
                                 stream<TcpSessionID,4>  timer_to_sttable_release_state_fifo("timer_to_sttable_release_state_fifo");
  ...
  stream<RxEngToRetransTimerReq, 4> rx_eng_to_timer_clear_rtimer_fifo("rx_eng_to_timer_clear_rtimer_fifo");
#pragma HLS aggregate variable = rx_eng_to_timer_clear_rtimer_fifo compact = bit
  stream<TxEngToRetransTimerReq, 4> tx_eng_to_timer_set_rtimer_fifo("tx_eng_to_timer_set_rtimer_fifo");
#pragma HLS aggregate variable = tx_eng_to_timer_set_rtimer_fifo compact = bit

  stream<OpenConnRspNoTDEST, 4> rtimer_to_tx_app_notification_fifo("rtimer_to_tx_app_notification_fifo");
