...
if {$hls_act == "synth"} {
  csynth_design
  export_design -rtl verilog -format ip_catalog -ipname "icmp_server"
}

if {$hls_act == "cosim"} {
  cosim_design -rtl verilog  -argv  "${pcap_input_dir}/icmp_request.pcap ${pcap_input_dir}/icmp_response_golden_with_ipv4_checksum.pcap"
}
